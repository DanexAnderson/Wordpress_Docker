...
<header class="site-header">
    <div class="container">
      ...
      <strong>Fictional</strong> University</a></h1>
      ...
      <div class="site-header__menu group">
        ...
        ?>
          ...
          <ul>
            <li <?php if (is_page('about') or wp_get_post_parent_id(0) ==51) echo 'class="current-menu-item"' ?> >
        ...
        <div class="site-header__util">
          <?php 
                if (is_user_logged_in()) {
                  ...
                  ?>
                  <a href="<?php echo esc_url(site_url('/my-notes')); ?>" class="btn btn--small btn--orange float-left push-right">MyNotes</a>
                  <a href="<?php echo wp_logout_url(); ?>" 
                  class="btn btn--small btn--with-photo btn--dark-orange float-left">
                ...
                <span class="btn__text">logout</span></a>
                  ...
                  <a href="<?php echo wp_registration_url(); // esc_url(site_url('/wp-signup.php')); ?>"
